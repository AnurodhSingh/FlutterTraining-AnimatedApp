...
class CompanyDetsIntroAnimation {
  CompanyDetsIntroAnimation(this.controller)
      : bgdropOpacity = new Tween(begin: 0.5, end: 1.0).animate(
        ...
        dividerWidth = new Tween(begin: 0.0, end: 1.0).animate(
            new CurvedAnimation(
                parent: controller,
                curve:
                    new Interval(0.650, 0.750, curve: Curves.fastOutSlowIn))),
